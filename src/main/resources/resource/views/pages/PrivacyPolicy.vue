        ...
        <div class="w-200">
          <div class="clearfix">
            ...
            <p>
              ...
              > but some details were modified after that.
            </p>
            ...
            <ul>
              ...
              <li>
                <p>
                  <strong>This Website</strong> (referred to as either &quot;the
                  Website&quot;, &quot;We&quot;, &quot;Us&quot; or
                  &quot;Our&quot; in this Agreement) refers to ChatBoard. This website is managed by an individual, not by a company.
                </p>
              </li>
              <!-- <li>
                <p>
                  <strong>Google</strong> refers to <a href="https://about.google/" target="_blank">the company</a> that provides <a href="https://support.google.com/adsense" target="_blank">Google Adsense</a>. 
                  This website is using Google Adsense for its advertisement.
                </p>
              </li> -->
              <li>
                <p>
              ...
              <li>
                <p><strong>Service</strong> refers to our website ChatBoard.</p>
              </li>
              <li>
                <p>
                  <strong>Service Provider</strong> means any natural or legal
                  person who processes the data on behalf of this Website. It
                  refers to third-party companies or individuals employed by
                  us to facilitate the Service, to provide the Service on
                  behalf of the Website, to perform services related to the
                  Service or to assist the Website in analyzing how the Service
                  is used.
                </p>
              </li>
              <li>
              ...
              <li>
                <p>
                  <strong>Website</strong> refers to the ChatBoard, this website.
                </p>
              </li>
              <li>
                <p>
            ...
            <!-- <p>We are using <strong>Google Adsense</strong> 
            as such, third party vendors, including Google, 
            use cookies to serve ads based on a user's prior visits to your website or other websites.
            </p> -->
            <!-- <p>Visitors/Users of our website may opt out of personalized advertising by visiting <a href="https://adssettings.google.com/authenticated" target="_blank">Ads Settings</a> of Google.</p> -->
            <p>
                Third-party vendors and ad networks might serve ads and use their cookies on this website. You can opt out of some third-party vendors’ uses of cookies for personalized advertising by visiting <a href="https://optout.aboutads.info/" target="_blank">www.aboutads.info</a>.
            </p>
            <p>
            ...
            <ul>
              ...
              <li>
                ...
                may contain small electronic files known as web
                beacons (also referred to as clear gifs, pixel tags, and
                single-pixel gifs) that permit us, for example, to
                count users who have visited those pages and
            ...
            <p>
              <strong>chat_board_login_token</strong> and <strong>auth_stay_signed_in</strong> are our cookies that are used to control session of this website. 
              <br/><strong>XSRF-TOKEN</strong> is the cookie to prevent Cross-Site Request Forgery (CSRF) attack.
              <br/>Other cookies are managed by third party.  
            </p>
            ...
            <ul>
              ...
              <li>
                <p>
                  <strong>To provide You</strong> with email for <strong>email verification</strong> and <strong>account verification</strong> URLs.
                </p>
              </li>
              <li>
                <p>
            ...
            <ul>
              ...
              <li>
                ...
                negotiations of, any merger, sale of our assets, financing,
            ...
            <p>
              ...
              Website's operating offices and in any other places where the
            ...
            <p>
              The Website may disclose Your Personal Data in the good faith
            ...
            <ul>
              <li>By email: chatboard.contact@gmail.com</li>
            </ul>
          </div>
        </div>
      </CCol>
